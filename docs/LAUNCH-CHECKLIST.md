...
- [x] **Branded OG-kép kész** — új **1200×630 navy + arany logó** OG-kép (`/og-image.png`) az egész oldal alapértelmezett megosztási képe (ingatlan-oldal a saját fotóját használja)
...
- [x] **Új brand-logó** mindenhol (navbar, footer, admin, print, favicon, OG) — széles rose-gold lockup
- [x] **Hero háttérvideó** — 1080p 1,55 MB (4,24-ből), poster-kép azonnal (LCP), videó **csak desktopon** (mobilon/Save-Data/reduced-motion nem tölti le)
