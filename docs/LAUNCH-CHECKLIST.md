...
- [x] **Alap OG-kép beállítva** — jelenleg a logó (ingatlan-oldal a saját fotóját használja)
- [ ] **⭐ Egyedi OG-képek** — a logó gyenge OG-előnézet! Kell branded **1200×630 navy/arany** kép(ek): főoldal, lista, kapcsolat (és ahova kell). *(💻 legenerálom, ha megvan a stílus/logó nagyban)*
